  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold font-body transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        low: 'border-transparent bg-emerald-500/20 text-emerald-400 border-emerald-500/30',
        ...
        emergency: 'border-transparent bg-red-500/20 text-red-400 border-red-500/30 animate-pulse-slow',
        teal: 'border-transparent bg-teal-500/20 text-teal-400 border-teal-500/30',
      },
    },
    defaultVariants: {
      variant: 'default',
